...
var RouteTraverser = (function () {
    ...
    */
    ...
    RouteTraverser.prototype._matchRouteDeep = function (route, queryParams, locationChange, pathname, remainingPathname, paramNames, paramValues) {
        ...
        return Observable_1.Observable.of(route)
            ...
            if (isTerminal) {
                ...
                return Observable_1.Observable.of(route)
                    .mergeMap(function (route) { return _this._loadIndexRoute(route); })
                    .map(function (indexRoute) {
                    if (!!indexRoute) {
                        match_1.routes.push(indexRoute);
                    }
                    return match_1;
                });
            }
    ...
    RouteTraverser.prototype._loadIndexRoute = function (route) {
...
function assignParams(paramNames, paramValues) {
